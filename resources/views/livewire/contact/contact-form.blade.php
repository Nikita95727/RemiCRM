                            ...
                            <div class="group relative">
                                ...
                                <div class="relative">
                                    <input wire:model="email" 
                                           type="email" 
                                           id="email"
                                           class="w-full px-4 py-3 text-slate-900 bg-white/80 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 text-base font-medium shadow-lg hover:shadow-xl focus:shadow-2xl backdrop-blur-sm transition-all duration-300 placeholder:text-slate-400 @error('email') border-red-300 focus:border-red-500 focus:ring-red-500/20 @enderror"
                        ...
                        <div class="group relative">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                @foreach($sources as $value => $label)
                                    @php $sourceObj = $sourceObjects[$value]; @endphp
                                    <label class="group/checkbox flex items-center p-2 bg-white/80 border-2 border-slate-200 rounded-lg hover:border-slate-300 hover:shadow-md cursor-pointer transition-all duration-200 {{ in_array($value, $selectedSources) ? 'border-indigo-500 bg-indigo-50/80 shadow-lg' : '' }}">
                                        <div class="relative">
                                            <input type="checkbox" 
                                                   wire:model="selectedSources" 
                                                   value="{{ $value }}"
                                                   class="sr-only">
                                            <div class="w-5 h-5 rounded-md border-2 {{ in_array($value, $selectedSources) ? 'border-indigo-500 bg-indigo-500' : 'border-slate-300 bg-white' }} flex items-center justify-center transition-all duration-200">
                            ...
                            <div class="group relative">
                                ...
                                <div class="relative">
                                    <input wire:model="tagsInput" 
                                           type="text" 
                                           id="tagsInput"
                                           class="w-full px-4 py-3 text-slate-900 bg-white/80 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 text-base font-medium shadow-lg hover:shadow-xl focus:shadow-2xl backdrop-blur-sm transition-all duration-300 placeholder:text-slate-400 @error('tagsInput') border-red-300 focus:border-red-500 focus:ring-red-500/20 @enderror"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button wire:click="save" 
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <span>{{ $isEdit ? 'Update Contact' : 'Create Contact' }}</span>
                            </div>
