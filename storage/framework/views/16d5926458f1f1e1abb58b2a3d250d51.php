        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900">
                                <?php echo e(auth()->user()->email_verified_at ? 'Yes' : 'No'); ?>
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    ...
                    <a href="<?php echo e(route('two-factor.settings')); ?>" 
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Documents/Remi CRM/crm-backend/resources/views/profile.blade.php ENDPATH**/ ?>