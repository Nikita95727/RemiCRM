                        ...
                        <div class="flex items-center space-x-8">
                            ...
                            <div class="hidden md:flex items-center">
                                <a href="<?php echo e(route('contacts')); ?>" 
                                   class="text-slate-700 hover:text-indigo-600 px-3 py-2 rounded-lg text-sm font-semibold transition-colors duration-200 <?php echo e(request()->routeIs('contacts') ? 'text-indigo-600 bg-indigo-50' : ''); ?>">
                                    Contacts
                                </a>
                            </div>
                        </div>
...
[$__name, $__params] = $__split('contact.global-search');

$__html = app('livewire')->mount($__name, $__params, 'lw-226583786-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/macbook/Documents/Remi CRM/crm-backend/resources/views/layouts/app.blade.php ENDPATH**/ ?>