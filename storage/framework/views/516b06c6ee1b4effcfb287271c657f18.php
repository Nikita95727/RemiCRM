...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> - Integration</title>
...
<body class="font-sans antialiased bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 min-h-screen">
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-md w-full">
            ...
            <div class="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8 text-center">
                ...
                <!-- Cancel Button -->
                <button onclick="window.location.href='<?php echo e(route('contacts')); ?>'" 
    ...
    <script>
        ...
        function checkIntegrationStatus() {
            ...
            fetch('<?php echo e(route('integration.check-status')); ?>', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                ...
                if (data.status === 'success') {
                    ...
                    setTimeout(() => {
                        window.location.href = data.redirect || '<?php echo e(route('contacts')); ?>';
                    }, 2000);
                    
                } else if (data.status === 'no_pending') {
                    updateStatus('No pending integration found. Redirecting...');
                    setTimeout(() => {
                        window.location.href = '<?php echo e(route('contacts')); ?>';
                    }, 2000);
...
<?php /**PATH /Users/macbook/Documents/Remi CRM/crm-backend/resources/views/integration-waiting.blade.php ENDPATH**/ ?>