                ...
                <div class="px-6 py-6 bg-gradient-to-b from-slate-50/80 via-white to-slate-50/50 backdrop-blur-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!--[if BLOCK]><![endif]--><?php if($provider['available']): ?>
                                    <!--[if BLOCK]><![endif]--><?php if($key === 'telegram'): ?>
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="flex items-start space-x-4">
                                        <div class="w-12 h-12 bg-gradient-to-r <?php echo e($provider['color']); ?> rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow duration-300">
                                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="<?php echo e($provider['icon']); ?>"/>
                                            </svg>
                                        </div>
                                        <div class="flex-1">
                                            <div class="flex items-center space-x-2">
                                                <h5 class="text-lg font-bold text-slate-900"><?php echo e($provider['name']); ?></h5>
                                                <!--[if BLOCK]><![endif]--><?php if(!$provider['available']): ?>
                                            ...
                                            <p class="text-slate-600 text-sm mt-1"><?php echo e($provider['description']); ?></p>
                                            
                                            <!-- Connected Accounts Icons -->
                                            <!--[if BLOCK]><![endif]--><?php if(isset($connectedAccounts[$key]) && count($connectedAccounts[$key]) > 0): ?>
                                                <div class="mt-3">
                                                    <p class="text-xs text-slate-500 mb-2">Connected accounts (<?php echo e(count($connectedAccounts[$key])); ?>):</p>
                                                    <div class="flex flex-wrap gap-2">
                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $connectedAccounts[$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="group relative">
                                                                <div class="w-8 h-8 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full flex items-center justify-center shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer hover:scale-110">
                                                                    <span class="text-white text-xs font-bold"><?php echo e(strtoupper(substr($account['name'], 0, 2))); ?></span>
                                                                </div>
                                                                <!-- Tooltip -->
                                                                <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-white text-black text-xs font-medium rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-50 pointer-events-none shadow-xl border border-gray-300">
                                                                    <div class="text-black font-bold"><?php echo e($account['name']); ?></div>
                                                                    <div class="text-gray-600 text-xs mt-1"><?php echo e($account['created_at']); ?></div>
                                                                    <!-- Tooltip arrow -->
...
<?php /**PATH /Users/macbook/Documents/Remi CRM/crm-backend/app/Modules/Integration/Resources/Views/connect-account.blade.php ENDPATH**/ ?>